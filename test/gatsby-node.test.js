              ...
              edges: [
                {
                  node: {
                    fields: {
                      slug: "/docs/2017-04-18--welcoming/"
                    }
                  }
                },
                {
                  node: {
                    fields: {
                      slug: "/docs/2017-05-02--article-2/"
                    }
                  }
                },
                {
                  node: {
                    fields: {
                      slug: "/docs/2017-05-02--article-1/"
                    }
                  }
                },
                {
            ...
            posts: {
              edges: [
                ...
                },
                {
                  node: {
                    fields: {
                      slug: "/docs/2017-05-02--article-0/"
                    },
                    frontmatter: {
                      tags: null
                    }
    ...
    describe("pagination", () => {
      const generateData = n => {
        const edges = [...Array(n)].map((val, i) => ({
          node: {
            fields: {
              slug: `/docs/2017-04-18--article-${i + 1}/`
            }
          }
        }));
      ...
      it("should create 1 page with 5 posts", () => {
        ...
        return createPages({ graphql, actions }).then(() => {
          const pages = actions.createPage.mock.calls.filter(
            d => d[0].path && d[0].path.startsWith("/docs/page/")
          );
  ...
  describe("onCreateNode", () => {
    ...
    it("should create slugs for MarkdownRemark file", () => {
      getNode.mockReturnValue({
        relativePath: "docs/2017-04-18--welcoming/index.md"
      });
      const node = {
        internal: {
          type: "MarkdownRemark"
