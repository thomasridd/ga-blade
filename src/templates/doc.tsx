...
interface DocPostProps extends LayoutProps {
  data: {
    post: MarkdownRemark;
...
export default withLayout(DocsPostPage);

export const pageQuery = graphql`
  query TemplateDocsPost($slug: String!) {
    site: site {
      siteMetadata {
        disqus
      }
